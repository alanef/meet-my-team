...
# Meet My Team - Development Guide
...
| | |
|---|---|
| Plugin directory | `meet-my-team/` |
| Main file | `meet-my-team/meet-my-team.php` |
| Default branch | `master` |
| WordPress.org slug | `meet-my-team` |
| wp-env ports | dev `8710`, tests `8711` |
| Version locations | plugin header `Version:`, `readme.txt` `Stable tag:` |
...
npm run start                     # wp-env (dev :8710, tests :8711, admin/password)
npm test                          # PHPUnit inside the wp-env tests container
npm test -- --filter Foo          # pass PHPUnit args through
composer run build                # zipped/meet-my-team-free.zip via wp dist-archive
```
